...
class Edit extends Component
{
	...
	UNSAFE_componentWillReceiveProps(user_data) {
		this.setState({
		    ...
		    qualification : user_data.user.qualification
		})
	}
			        ...
			        <form onSubmit={this.handleUpdateUser}>
			      		<div className="modal-body">
							  ...
							  <div className="form-group">
			            		...
			            		<input type="radio" className={`${this.hasErrorFor('gender') ? 'is-invalid' : ''}`}
			            		 id="gender" name="gender" value = "Male"  checked={this.state.gender=="Male"} onChange={this.handleInputFieldChange} />&nbsp;Male&nbsp;
			            		{this.renderErrorFor('gender')}
								<input type="radio" className={`${this.hasErrorFor('gender') ? 'is-invalid' : ''}`}
			            		 id="gender" name="gender" value = "Female" checked={this.state.gender=="Female"}  onChange={this.handleInputFieldChange} />&nbsp;Female&nbsp;
			            		{this.renderErrorFor('gender')}
								<input type="radio" className={`${this.hasErrorFor('gender') ? 'is-invalid' : ''}`}
			            		 id="gender" name="gender" value = "Others"  checked={this.state.gender=="Others"} onChange={this.handleInputFieldChange} />&nbsp;Others
			            		{this.renderErrorFor('gender')}
			          		</div>
							  <div> 
							<select name ="qualification"as="select" className={'form-control form-control-sm'} onChange={this.handleInputFieldChange} value={this.state.qualification}>
							<option value="" >---Select Qualification---</option>
                              <option value="Mtech"checked={this.state.qualification=="Mtech" } >Mtech</option>
                              <option value="Msc"checked={this.state.qualification=="Msc" } >Msc</option>
                             <option value="MCA"checked={this.state.qualification=="MCA" }>MCA</option>
                            </select>
							</div>
			      		</div>
